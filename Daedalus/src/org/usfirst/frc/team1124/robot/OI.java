...
public class OI {
	...
	public static Button climb = new JoystickButton(secondDriver,6);
	public static Button climbDown = new JoystickButton(secondDriver,8);
	...
	public OI() {
		...
		target.whileHeld(new TargetVisionTape());
	}
}
